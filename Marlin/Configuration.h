...
#define STRING_CONFIG_H_AUTHOR "(Vyacheslav Mayorov, default config)" // Who made the changes.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  // Duplicator 6
    ...
    // PID autotune with 100% fan on
    #define DEFAULT_KP_LIST {   12.7,   12.7 }
    #define DEFAULT_KI_LIST {   0.43,   0.43 }
    #define DEFAULT_KD_LIST {   92.7,   92.7 }
...
/*
04:55:29.042 -> MPC_BLOCK_HEAT_CAPACITY 25.52
04:55:29.074 -> MPC_SENSOR_RESPONSIVENESS 0.0541
04:55:29.074 -> MPC_AMBIENT_XFER_COEFF 0.0703
04:55:29.074 -> MPC_AMBIENT_XFER_COEFF_FAN255 0.2186
*/

  // Measured physical constants from M306
  #define MPC_BLOCK_HEAT_CAPACITY { 25.52f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.0541f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  // autocalibrated value: #define MPC_AMBIENT_XFER_COEFF { 0.0607f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #define MPC_AMBIENT_XFER_COEFF { 0.095f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.22f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 50, -1.5 }
