...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Duplicator 6
    ...
    #define DEFAULT_Kp_LIST {  11.22,  11.22 }
    #define DEFAULT_Ki_LIST {   0.34,   0.34 }
    #define DEFAULT_Kd_LIST {  94.56,  94.56 }
  #else
    #define DEFAULT_Kp  11.22
...
#define NOZZLE_TO_PROBE_OFFSET { 0, 50, -2.1 }
